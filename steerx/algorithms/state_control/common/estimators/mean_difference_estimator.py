...
from steerx.algorithms.state_control.common.estimators.base import BaseEstimator
from steerx.algorithms.state_control.common.estimators.contrastive_direction_estimator import (
    _layerwise_tokenwise_hidden,
)
from steerx.algorithms.state_control.common.specs import ContrastivePairs, VectorTrainSpec
    ...
    def fit(
        ...
        *,
        ...
        for layer_id in range(num_layers):
            ...
            # mean difference doesn't produce explained variance; use 1.0 as sentinel
            explained_variances[layer_id] = 1.0
