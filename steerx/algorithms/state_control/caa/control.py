...
from steerx.algorithms.state_control.common.token_scope import compute_prompt_lens, make_token_mask
from steerx.algorithms.state_control.common.transforms import AdditiveTransform, NormPreservingTransform

from steerx.algorithms.state_control.common.estimators import MeanDifferenceEstimator
    ...
    def steer(
        ...
        **__,
        ...
        if self.layer_id is not None:
            ...
            # heuristic: ~40% through the model (paper finds layer 13/32 optimal)
            self._layer_id = num_layers * 2 // 5
