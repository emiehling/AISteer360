...
from aisteer360.spipe.codec import EncodeContext, digest_of, encode, encoded_size
from aisteer360.spipe.errors import SpipeSaveError
from aisteer360.spipe.format import ARTIFACTS_DIR, FORMAT_VERSION
from aisteer360.spipe.store import ArtifactStore

if TYPE_CHECKING:
    from aisteer360.spipe.spipe import SPipe
...
def _toolkit_version() -> str:
    try:
        ...
        return version("aisteer360")
    except Exception:
        import aisteer360

        return getattr(aisteer360, "__version__", "unknown")
...
def build_spipe(pipeline, *, freeze: bool | None = None, model_ref: str | None = None) -> "SPipe":
    ...
    Raises:
        SpipeSaveError: If the model reference is unresolvable, a control is unregistered or
            ...
            cannot freeze.
    """
    from aisteer360.algorithms.core.identity import config_descriptor_from_controls, config_digest
    from aisteer360.algorithms.core.registry import method_key_for
    from aisteer360.spipe.spipe import SPipe
