...
here: [FewShot](../examples/notebooks/controls/few_shot.ipynb).
...
methods can be found in the notebooks: [MergeKit](../examples/notebooks/controls/mergekit_wrapper.ipynb)[@goddard-etal-2024-arcees],
[TRL](../examples/notebooks/controls/trl_wrapper.ipynb)[@vonwerra2022trl].
...
[CAST](../examples/notebooks/controls/cast.ipynb)[@lee2025programming], [PASTA](../examples/notebooks/controls/pasta.ipynb)[@zhang2024tell].
...
decoding. Some example methods can be found in the following notebooks: [DeAL](../examples/notebooks/controls/deal.ipynb)[@huang2024deal],
[RAD](../examples/notebooks/controls/rad.ipynb)[@deng-raffel-2023-reward], [SASA](../examples/notebooks/controls/sasa.ipynb)[@ko2025large],
[ThinkingIntervention](../examples/notebooks/controls/thinking_intervention.ipynb)[@wu2025effectively].
