...
Show off how cool your method is by writing a notebook (in `../examples/notebooks/controls/<custom_control>/`). A good notebook
...
See the [DeAL notebook](`../examples/notebooks/controls/deal.ipynb`) for an example.
