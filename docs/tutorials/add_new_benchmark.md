...
[`FewShot`](../examples/notebooks/controls/few_shot.ipynb) and [`DPO (with LoRA)`](../examples/notebooks/controls/trl_wrapper.ipynb). Both
...
[example notebook](../examples/notebooks/benchmarks/commonsense_mcqa.ipynb).
...
[PASTA](../examples/notebooks/controls/pasta.ipynb).
...
[notebook](../examples/notebooks/benchmarks/instruction_following.ipynb) for the full implementation.
