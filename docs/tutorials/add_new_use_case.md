...
please see the [instruction following benchmark notebook](../examples/notebooks/benchmarks/instruction_following.ipynb)
...
see the [tutorial](./add_new_benchmark.md) and the [notebook](../examples/notebooks/benchmarks/commonsense_mcqa.ipynb).
